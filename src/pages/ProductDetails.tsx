...
const ProductDetails = () => {
  ...
  /** ---> fetching product detail on load */
  useEffect(() => {
    if (parmas.id) {
      fetchProduct();
    }
  ...
  const fetchProduct = async () => {
    const res = await axiosInstance.get(`/products/${parmas.id}`);
    if (res.data) {
      setProduct(res.data);
  ...
  return (
    <section className="py-12 sm:py-16 mt-24">
            ...
            <li className="text-left">
              <div className="flex items-center">
                ...
                <div className="-m-1">
                  <NavLink
                    to="/"
                    className="rounded-md p-1 text-sm font-medium text-gray-100 focus:text-gray-300 focus:shadow hover:text-gray-300"
                  >
                    {" "}
                    Product{" "}
                  </NavLink>
              ...
              <div className="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                <div className="flex flex-row items-start lg:flex-col">
                  {product?.images.map((image) => {
                    return (
                      <button
                        onMouseEnter={() => setViewImage(image)}
                        type="button"
          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <ul className="mt-8 space-y-2">
              <li className="flex items-center text-left text-sm font-medium text-gray-200">
                <svg
                  className="mr-2 block h-5 w-5 align-middle text-gray-200"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
